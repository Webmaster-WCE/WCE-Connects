...
function Activities() {
    return (
        <div style={{display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center'}}>
            <div>
                <p style={{fontWeight:"bold", fontFamily:"Montserrat", fontStyle:"italic"}}><a href='http://walchandsangli.ac.in/Alumni/Activities/Activity1.pdf' style={{color:"#702aff"}}>Click here to fill Activity Form</a></p> 
            </div>
            <div>
                <p style={{fontSize:"x-large", fontWeight:"bold", fontFamily:"Montserrat"}}>Alumni Activities</p>
            </div>
            <div class="context-text" style={{textAlign:"left",marginBottom:"50px",borderRadius:"50px",padding:'30px', fontFamily:"Montserrat", maxWidth:"700px", textAlign:"center", backgroundColor:"#ededed"}}>
