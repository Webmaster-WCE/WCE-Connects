...
export default function Graduation() {
    ...
    const Schedule = [
        ...
        createSceduleData("3:40 pm", "Inauguration of New facilities at Exam Section and Projection of Virtual GDC link","5 min"),
        ...
        createSceduleData("4:05 pm", "@ Tilak Hall for GDC Program","5 min"),
        createSceduleData("4:10 pm", "Saraswati Vandana ","5 min"),
        createSceduleData("4:15 pm", "Welcome and Felicitation of VC","5 min"),
        createSceduleData("4:20 pm", "Welcome Address by Director","5 min"),
        createSceduleData("4:25 pm", "Address by Chairman, Shri. Ajitji Gulabchand (video)","15 min"),
        createSceduleData("4:40 pm", "Address by Dr. Raghunath Mashelkar (video) ","25 min"),
        createSceduleData("5:05 pm", "Address by VC","10 min"),
        createSceduleData("5:15 pm", "Award Ceremony","35 min"),
        createSceduleData("5:50 pm", "Student Feedback","10 min"),
        createSceduleData("6:00 pm", "Vote of Thanks","3 min"),
        createSceduleData("6:03 pm", "National Anthem","5 min"),
        createSceduleData("6:08 pm", "Tree Plantation in Exam Section Premises","10 min"),
        createSceduleData("6:18 pm", "High Tea at Saraswati Idol premises","30 min"),
        createSceduleData("6:48 pm", "Cultural event @ Library Staircase","")
        ...
        <div className='eventpage_root' >
                ...
                <Grid container style={{padding:"3%"}}>
                    <Grid item xs={12} sm={6}>
                        <div style={{  }} className={classes.abc}>
                            ...
                            <p style={{ fontSize: "large", fontWeight: "bold", fontFamily: "Montserrat" }}>Date & Time : 17<sup>th</sup> May at 3.3 0 pm</p>
                        ...
                        <div style={{  }} className={classes.xyz} >
                            <div>
                              <p style={{fontWeight: "bold", fontFamily: "Montserrat" }}>Link to view Virtual GDC: <a href={"https://youtu.be/VXQqI9gtwrs" }className="blink_me" target="_blank">click here</a></p>
                                 <p><small>Content under this link will be publicly available after 4pm on 17th May.</small></p>
            ...
            <div style={{ fontFamily: "Montserrat" }}>
                ...
                <p style={{ fontSize: "x-large", backgroundColor: "#e6e6e6", padding: "5%", margin: "1% 10%", textAlign: "left", lineHeight: "1.5", borderRadius: "30px" }}>
                    ...
                    <br/><br/>
                    Guest: Dr. D. T. Shirke, Vice-Chancellor, Shivaji University, Kolhapur
                </p>
