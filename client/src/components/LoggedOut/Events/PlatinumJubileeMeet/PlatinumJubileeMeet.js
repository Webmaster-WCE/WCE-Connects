...
export const PlatinumJubileeMeet = () => {
   const classes = useStyles();
    ...
    const Schedule = [
        ...
        createSceduleData("10.00 am to 10.05 am", "Ish-stawan and Saraswati Poojan"),
        createSceduleData("10.05 am to 10.15 am", 'Brief presentation on “75 years of glory, never-ending quest for excellence"'),
        createSceduleData("10.15 am to 10.25 am", "Felicitation of Dignitaries"),
        createSceduleData("10.25 am to 10.35 am", "Welcome note by Director, WCE"),
        createSceduleData("10.35 am to 10.50 am", "Address by Chief Guest Mr. Mahesh Palashikar, President, General Electric - South Asia"),
        createSceduleData("10.50 am to 11.05 am", "Address by Prof. G. D. Yadav Former Vice-Chancellor, Institute of Chemical Technology, Mumbai"),
        createSceduleData("11.05 am to 11.15 am", "Address by Mr. Ramkumar H. Rathi, Director, Beharay Rathi Group, Pune"),
        createSceduleData("11.15 am to 11.45 am", "Felicitation of Distinguished Alumni & Industry representative"),
        createSceduleData("11.45 am to 12.20 pm", "Panel Discussion on “Role of Alumni and Industry in Development of WCE”"),
        createSceduleData("12.20 pm to 12.50 pm", "Reminiscences of student hood: Portraying by Alumni"),
        createSceduleData("12.50 pm to 12.55 pm", "Vote of Thanks"),
        createSceduleData("12.55 pm to 01.00 pm", "National Anthem"),
        createSceduleData("01.00 pm to 02.30 pm", "Lunch"),
        createSceduleData("02.30 pm to 03.15 pm", "Exploring New Facilities Created"),
        createSceduleData("03.15 pm to 05.00 pm", "Welcome, Interaction and Felicitation of retired faculty and staff at the respective department"),
        createSceduleData("05.00 pm to 05.30 pm", "Farewell & Go ahead"),
        createSceduleData("05.30 pm to 07.30 pm", "Cultural Programme"),
    ];
        ...
        <div className='eventpage_root' >
                ...
                <Grid container style={{padding:"3%"}}>
                    <Grid item xs={12} sm={6}>
                        <div style={{  }} className={classes.abc}>
                            <p style={{ fontSize: "large", fontWeight: "bold", fontFamily: "Montserrat" }}>EVENT DAY: Saturday, 9th April 2022</p>
                            <p style={{ fontSize: "large", fontWeight: "bold", fontFamily: "Montserrat" }}>EVENT TIME: 9am onwards</p>
                            <p style={{fontWeight: "bold", fontFamily: "Montserrat" }}>Live Streaming: <a href={"https://youtu.be/AlfKOvkegM4" }className="blink_me" target="_blank">Platinum Jublee Meet Live Streaming</a></p>
                    ...
                    <Grid item xs={12} sm={6}>
                        <div style={{  }} className={classes.xyz} >
                            <div>
                                <Link to="/events/PlatinumJubileeMeet/PreRegistration" style={{ textDecoration: "none" }}>
                                    <Button
                                        type="submit"
                                        variant="contained"
                                ...
                                <p><small style={{color:'red'}}>Registration link will be closed by 5th April 2022, 5.00 pm IST</small></p>
                            </div>
            ...
            <div style={{ fontFamily: "Montserrat" }}>
                ...
                <p style={{ fontSize: "x-large", backgroundColor: "lightgrey", padding: "5%", margin: "1% 10%", textAlign: "left", lineHeight: "1.5", borderRadius: "30px" }}>
                    Every alumni meet has been a significant event for all the stakeholders associated with our institute. The 75th anniversary of WCE, our Platinum Jubilee, is a very special event that we wish to celebrate together in our campus on the <strong>9th day of April 2022</strong>. As intended every year, this meet also ensures strengthening a strong bond between the alumni and current stakeholders of the institute. Please spare your time to witness progress of alma matter, meet and felicitate your teachers, be a role model for young students and extend yourself by giving back to the institute what it deserves !</p>
            </div>
             <div>
                ...
                <TableContainer component={Paper} style={{ margin: "0% 8%", backgroundColor: "lightgrey", fontFamily: "Montserrat" }}>
                    <Table size="small">
                        <TableBody>
                            ...
                            <TableRow align="left" style={{ background: "#e6e6e6"}}>
                                <TableCell colSpan={2}>
                                    <div style={{ marginLeft: "4%", fontFamily: 'Montserrat', fontSize: 'large' }}>
                                        ...
                                        <p>Please Note – </p>
                                        <ul>
                                            <li>The spot registration & money transaction is not permitted. The details of accompanying
members should also be communicated at the time of online registration</li>
                                            <li>All the participants should take all precautions recommended for COVID, including
wearing a well-fitted mask</li>
