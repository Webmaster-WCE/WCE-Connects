...
export default function Events() {
  ...
  const events = [
    ...
    },
    {
      ...
      routeName:"PlatinumJubileeMeet"
    },
    {
      eventid: 2,
      banner: `${PF}events/Graduation.webp`,
      title: "Graduation Day",
      description: " Graduation day ceremony 2019- 20 and 2020-21",
      routeName:"Graduation"
    },
    {
      eventid: 3,
            ...
            <Grid container spacing={2}>
            {
              events && events.map((event) => {
                return <Grid item key={event.eventid} style={{ height:"100%"}} xs={12}  sm={6} lg={4} >
                  <Card>
                    <Link to={`events/${event.routeName}`} style={{textDecoration:"none"}} >
                      <CardActionArea>
                        <CardMedia
                          component="img"
                          alt="EVENT_BANNER"
