            ...
            <div style={{ backgroundColor:"black", fontFamily:"Montserrat"}}>
                <div style={{ display: 'flex', justifyContent: 'space-around'}}>
                        ...
                        <div style={{display:"flex", flexDirection:"column", color:"white", textAlign: "left", padding:"3% 0% 1% 0%"}}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-evenly', alignItems: 'center'}}>
                                ...
                                <div>
                                    ...
                                    <p style={{ fontSize:"1.05rem", color:"grey", marginTop:"-1%"}}>
                                    <p style={{ marginBottom:"8px"}}>&nbsp;&nbsp;&nbsp;&nbsp;Website: <a href="http://www.walchandsangli.ac.in" target="_blank" rel="noreferrer" style={{color:"grey"}}>www.walchandsangli.ac.in</a><br/></p>
                                    &nbsp;&nbsp;&nbsp;&nbsp;Email: <a href="mailto:wce@walchandsangli.ac.in" target="_blank" rel="noreferrer" style={{color:"grey"}}>wce@walchandsangli.ac.in</a></p>
                                </div>
                            </div>
                        </div>
                    {/* </div> */}
                    <div style={{display:"flex", flexDirection:"column", color:"white", textAlign: "left", padding:"3% 0% 1% 0%"}}>
                        ...
                        <p style={{ fontSize:"medium", color:"grey", marginTop:"-5%"}}>
